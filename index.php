...
<head>
  ...
  <title>Metropolis Capital Bank</title>
...
<body>
  ...
  <section class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content">Metropolis Capital Bank</span>
      </div>
    ...
    <div class="topContentImg">
      <img src="images/banking1_homepage.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/about1.jpg" alt="Metropolis Capital Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <span class="text">Metropolis Capital Bank</span>
          </div>
          <div class="mt-2">
            <span class="sub-content">It is a web application where it demonstrates transferring money in hassle free way for making transactions between users.
  ...
  <section class="container" id="services">
    ...
    <div class="container  text-center">
      <div class="row">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transactions1.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transfer1.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
  ...
  <footer>
    <div class="follow">
      <h3 style="color: purple; font-family: 'Baloo Bhai 2', cursive; font-size: 25px;">Follow Us on our Social Platforms</h3>
      <div class="social">
    ...
    <p class="text-copy">
      Copyright &copy; Metropolis Capital Bank All Rights Reserved.
    </p>
  </footer>
  <!-- End Footer -->
